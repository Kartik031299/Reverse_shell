...
host="Kartik0312-61765.portmap.io"  # it will store static IP of server/ dynamic IP of machine on which server.py file is running
port=61765  # it will store port number on which server is listening

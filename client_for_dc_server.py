...
host="DCOP-58527.portmap.host"  # it will store static IP of server/ dynamic IP of machine on which server.py file is running
port=58527  # it will store port number on which server is listening
